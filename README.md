...
* If the name has been mangled phonetically - and the first part *kond* - is indeed indicative of a count level title in a Latin-derived vulgar language - most probably a French dialect - then making an exhaustive list is not a very difficult task. In particular, the list in [7] is very helpful ([7], page 393). In fact, aside from the French Forez familiy - which is the only perfect phonetic match - there are only two other very close matches:
  ...
  - Count Roger de Flor is a very interesting match - he was a mercenary, commander of the Great Catalan Company, who held the title Count of Malta, and who was adopted by the Byzantine Imperial Family. He married Maria Asenina, daughter of Tzar Ivan Asen III of Bulgaria.
